...
JLCXX_MODULE define_julia_module(jlcxx::Module& mod) {
    ...
    mod.add_type<Workspace>("Workspace")
        .constructor()
        .method("z", [](Workspace& w) { return to_julia(w.x->z); })
        .method("s_ineq", [](Workspace& w) { return to_julia(w.x->s_ineq); })
        .method("s_comp", [](Workspace& w) { return to_julia(w.x->s_comp); })
        .method("m_eq", [](Workspace& w) { return to_julia(w.x->m_eq); })
        .method("m_ineq", [](Workspace& w) { return to_julia(w.x->m_ineq); })
        .method("m_comp", [](Workspace& w) { return to_julia(w.x->m_comp); })
